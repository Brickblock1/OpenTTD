...
CommandCost CmdBuildTunnel(DoCommandFlag flags, TileIndex tile_start, TransportType transport_type, TunnelType tunnel_type, uint8_t road_rail_type);
...
void CcBuildTunnel(Commands cmd, const CommandCost &result, TileIndex tile_start, TransportType transport_type, TunnelType, uint8_t);
